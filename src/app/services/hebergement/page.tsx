...
export const metadata: Metadata = { title: 'Hébergement Web Professionnel — CDN Mondial', description: 'Hébergement sur CDN mondial avec uptime 99.9% garanti. Vercel, AWS, OVH — nous choisissons la meilleure solution selon votre projet.' }
const items = ['Hébergement CDN mondial','Uptime 99.9% garanti','SSL / HTTPS inclus','Domaine custom configuré','Emails professionnels','Monitoring 24/7','Sauvegardes automatiques','Support réactif']
export default function Page() {
  return (<>
    <PageHero badge="🌐 Hébergement Web" title="Infrastructure" highlight="fiable & rapide" description="Hébergement sur CDN mondial avec uptime 99.9% garanti. Vercel, AWS, OVH — nous choisissons la meilleure solution selon votre projet.">
    ...
    <section className="py-24"><div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
      <SectionTitle badge="Notre prestation" title="Ce qui est" highlight="inclus" description="Hébergement sur CDN mondial avec uptime 99.9% garanti. Vercel, AWS, OVH — nous choisissons la meilleure solution selon votre projet." />
