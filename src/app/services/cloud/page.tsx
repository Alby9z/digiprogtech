...
export default function Page() {
  return (<>
    <PageHero badge="☁️ Cloud" title="Scalez sans" highlight="limites" description="Infrastructure cloud qui s'adapte à votre croissance. De 100 à 1 million de visiteurs, vos serveurs suivent automatiquement.">
    ...
    <section className="py-24"><div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
      <SectionTitle badge="Notre prestation" title="Ce qui est" highlight="inclus" description="Infrastructure cloud qui s'adapte à votre croissance. De 100 à 1 million de visiteurs, vos serveurs suivent automatiquement." />
